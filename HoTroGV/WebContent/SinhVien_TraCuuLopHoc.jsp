...
<head>
    ...
    <script src="bootstrap/js/bootstrap.min.js"></script>
  	<title>Tra cứu</title>
  	<script src="f_TraCuuLopHoc.js"></script>
</head>
<body>
	<div class="container">
		<div class="row">
				...
				<div class="panel panel-primary">
			      	...
			      	<div class="panel-body">
			      		<div class="list-group">
							...
							<a href="SinhVien_TraCuuLopHoc.jsp" class="list-group-item active"><span class="glyphicon glyphicon-search"></span>Tra cứu lớp học</a>
			      	...
			      	<table class="table table-bordered">
					    ...
					    <tbody>
					      <tr>
					        ...
					        <td>29/08/2016</td>
					        <td>05/12/2016</td>
					        <td>Thứ 2, Tiết 7-11, Phòng A4-302</td>
					        
					      </tr>
					      <tr>
					        <td>Lập trình web nhóm 2</td>
					        <td>30/08/2016</td>
					        <td>05/12/2016</td>
					        <td>Thứ 3, Tiết 1-5, Phòng A4-302</td>
					       
					      </tr>
					      <tr>
					        <td>Lập trình web nhóm 3</td>
					        <td>30/08/2016</td>
					        <td>05/12/2016</td>
					        <td>Thứ 3, Tiết 7-11, Phòng A4-302</td>
