		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="SinhVien_TinNhanDaNhan.jsp" style="background-color: green">Tin nhắn</a></li>
                </ul>
    ...
    <marquee bgcolor="#f78af7" width = "1140px" height = "30px"><strong><h4>ĐỒ ÁN HỖ TRỢ VIỆC GIẢNG DẠY CHO GIẢNG VIÊN CỦA NHÓM-10 NĂM HỌC 2016-2017</h4></strong></marquee>
		<div class="row">
		  ...
		  <div class="col-md-10">
		  	<div class="panel panel-primary">
				 <!-- Default panel contents -->
				 <div class="panel-heading" align="center"><span class="glyphicon glyphicon-envelope"></span> TIN NHẮN ĐÃ NHẬN</div>
				 <div class="scroll">
				 	 <div class="panel-body">
				 	<div class="panel panel-success">
					      ...
					      <div class="panel-body">
					      	...
					      	<p>To: <span class="glyphicon glyphicon-user"></span> Admin | Đặng Thị Kim Giao | 12/09/2016 07:21:32 PM</p>
					      </div>
